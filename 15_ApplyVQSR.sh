...
date > documentation/run_time/15_ApplyVQSR_run.time
...
gatk --java-options "-Xms2G -Xmx2G -XX:ParallelGCThreads=2" ApplyVQSR \
	...
	-mode SNP \
	--recal-file "SNP_worm_2024_exome.recal" \
	--tranches-file "SNP_worm_2024_exome.tranches" \
	--truth-sensitivity-filter-level 99.95 \
	--create-output-variant-index 'true' \
	-O SNP_worm_2024_exome_recalibrated_99.95.vcf.gz

# record end time
date >> documentation/run_time/15_ApplyVQSR.time
